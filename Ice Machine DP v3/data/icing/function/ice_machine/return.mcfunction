...
#Source: https://minecraftcommands.github.io/wiki/questions/storeinventory#dont-care-about-the-slot
...
#Fixed in line 16 of gui.mcfunction. There was one bug. If you hold right click to place multiple of one item, all except one of the items will return to you as stone.
