...
#Put the appropriate ice crystal gui covering back into the storage
...
#Not sure why, but placing the gui item and the fuel back right here fixes the stone issue and the gui disappearing
data modify block ~ ~ ~ Items set from storage ice fuel

#Remove items that aren't going to be given back to player.
